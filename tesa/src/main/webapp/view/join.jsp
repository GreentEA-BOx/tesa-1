        ...
        <div class="flex-w flex-sb bo10 p-t-15 p-b-20">
            <div class="m-auto w-full-sm">
                <div class="size13 bo4 m-b-12 dis-inline-block">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" id="아이디" placeholder="아이디">
                ...
                <div class="size13 t-center bo4 m-b-12">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" id="pw" placeholder="비밀번호">
                </div>
                
                <div class="size13 t-center bo4 m-b-12">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" id="pw2" placeholder="재확인">
                </div>
                
                <div class="size13 t-center bo4 m-b-12">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" id="name" placeholder="이름">
                </div>
				...
				<div class="join-tel">
	                ...
	                <div class="size13 t-center bo4 m-b-12 m-l-10 float-l">
	                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" id="tel" placeholder="연락처">
	                </div>
                </div>
            ...
            <!--     
                ...
                <div class="size13 t-center bo4 m-b-12 float-l">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" id="email" placeholder="이메일">
                </div>
