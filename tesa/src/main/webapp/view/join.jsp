        ...
        <div class="flex-w flex-sb bo10 p-t-15 p-b-20">
            ...
            <form action="join" method="post">
                <div class="size13 bo4 m-b-12 dis-inline-block">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" id="아이디" name="id" placeholder="아이디">

                </div>
                <div class="size25 trans-0-4 m-b-10 dis-inline-block">
                    <!-- Button -->
                    <button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4"> 중복확인</button>
                </div>
                
                <div class="size13 t-center bo4 m-b-12">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="password" name="pw" id="pw" placeholder="비밀번호">
                </div>
                
                <div class="size13 t-center bo4 m-b-12">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="password" id="pw2" placeholder="재확인">
                </div>
                
                <div class="size13 t-center bo4 m-b-12">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" name="name" id="name" placeholder="이름">
                </div>
				...
				<div class="join-tel">
	                ...
	                <div class="size13 t-center bo4 m-b-12 m-l-10 float-l">
	                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" name="phone2" id="tel" placeholder="연락처">
	                </div>
                </div>
            ...
            <!--     
                ...
                <div class="size13 t-center bo4 m-b-12 float-l">
                    <input class="sizefull s-text7 p-l-15 p-r-15" type="text" id="email" name="email1" placeholder="이메일">
                </div>
                ...
                <div class="size25 trans-0-4 m-b-10 float-l">
                    <!-- Button -->
                    <button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4 dis-inline-block">인증 </button>
                </div>
                </div>
                ...
                <div class="container t-center">
                    <div class="size25 trans-0-4 m-b-10 dis-inline-block">
                        <button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">가입</button>
                    </div>
                    <div class="size25 trans-0-4 m-b-10 dis-inline-block">
                        <!-- Button -->
