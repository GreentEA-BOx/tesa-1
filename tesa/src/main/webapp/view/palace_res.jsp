<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script>
     function s(value){
    	 $('#sss').empty();
    	 $('#sss').append(parseInt(value) * 1000);
     }
     
     function submit(){
    	 var pay = $("#sss").text();
    	 location.href='palace_cho.jsp?pay='+pay;
     }
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 p-b-30">
					...
					<form class="wrap-form-reservation size22 m-l-r-auto" method="get">
						<div class="row">
							<div class="col-md-4">
								<!-- Date -->
								<span class="txt9">
							...
							<div class="col-md-4">
								...
								<div class="wrap-inputpeople size11 bg-white bo16 bo-rad-10 p-t-13 p-l-15 p-r-15 m-t-3 m-b-23">
									<!-- Select2 -->
									<select class="selection-1" name="people" onchange="javascirpt:s(this.options[this.selectedIndex].value)">
