						...
						<div class="filter-price p-t-22 p-b-50 bo3">
							...
							<div class="flex-sb-m flex-w p-t-16">
								...
								<div class="s-text3 p-t-10 p-b-10">
									가격범위: <span id="value-lower"></span>원 - <span id="value-upper"></span>원
								</div>
							</div>
						</div>
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="row">
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="${pageContext.request.contextPath}/images/dining/kyu.jpg"  alt="IMG-DINING">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelbest_d">
									<img src="${pageContext.request.contextPath}/images/dining/bur.jpg" alt="IMG-DINNING">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="${pageContext.request.contextPath}/images/dining/coco.jpg" alt="IMG-DINING">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelbest_d">
									<img src="${pageContext.request.contextPath}/images/dining/don.jpg" alt="IMG-DINING">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelbest_d">
									<img src="${pageContext.request.contextPath}/images/dining/ke.jpg" alt="IMG-DINING">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="${pageContext.request.contextPath}/images/dining/ore.jpg" alt="IMG-DINING">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="${pageContext.request.contextPath}/images/dining/ozing.jpg" alt="IMG-DINING">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="${pageContext.request.contextPath}/images/dining/sal.jpg" alt="IMG-DINING">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="${pageContext.request.contextPath}/images/dining/sset.jpg" alt="IMG-DINING">
