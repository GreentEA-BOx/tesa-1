<!-- Title Page -->
	...
	<div class="container">
		<nav>
			<ul>
				<li class=" m-r-10"><a href="bus.jsp">HOME</a></li>
				<li class=" m-r-10 p-l-10 p-r-10 bo2"><a href="b_reserv.jsp">Reservation</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 p-b-30">
					...
					<div class="wrap-btn-booking flex-l-m m-t-6">
							<!-- Button3 -->
							<button type="button" class="shu flex-c-m size13 txt11 p-l-10 p-r-10 trans-0-4">
								Shuttle
							</button>
							<button type="button" class="safa flex-c-m size13 txt11 p-l-10 p-r-10 trans-0-4">
								Safari
							</button>
					</div>

					<form class="wrap-form-reservation size22 m-l-r-auto shuttle on">
						<h4 class="p-t-40 p-b-40">Shuttle</h4>
						<div class="row">
							<div class="col-md-4">
								<!-- Date -->
								<span class="txt9">
					...
					<form class="wrap-form-reservation size22 safari m-l-r-auto">
						<h4 class="p-t-40 p-b-40">Safari</h4>
						<div class="row">
							<div class="col-md-4">
								<!-- Date -->
								<span class="txt9">
