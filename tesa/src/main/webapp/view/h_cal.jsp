...
// Calendar buttons
document.write('<div id="b_s" style="z-index:1000;position:absolute;visibility:hidden;cursor:pointer;float:left;width:20px;height:21px" onclick="csubm()"><img src="http://dev.capetown-direct.com/arrowleft-g.gif"></div>');
document.write('<div id="b_a" style="z-index:1000;position:absolute;visibility:hidden;cursor:pointer;float:right;width:20px;height:21px" onclick="caddm()"><img src="http://dev.capetown-direct.com/arrowright-g.gif"></div>');
