...
<section class="bg-title-page p-t-80 p-b-80 flex-col-c-m"
	style="background-image: url(${pageContext.request.contextPath}/images/r_detail.jpg);">
	...
	<ul>
		<li class="r_reli"><p
			...
			좌석 예약 시간</p><p class="r_ree">공연 전일 오전 8:00 ~ 익일 오후 8:00</p></li>
		<!-- Button -->
		<li class="r_reli"><p
			class="flex-c-m r_rebtn con-tc s-text1 trans-0-4">
			좌석 예약 공연</p><p class="r_ree">${cdelist.C_TITLE}</p></li>
			</ul>
	</div>
	...
	<div class="cardbig1">
		...
		<div class="card1 dis-inline-block">
			<p class="cardtitle1"><img src="${pageContext.request.contextPath}/images/r_danger.png">좌석예약 전 확인하세요</p>
...
<section class="bg-title-page p-t-50 p-b-50 flex-col-c-m">
	<div class="flex-w flex-m w-full-sm m-t-10 m-b-10 btnw2">
					<button
						...
						좌석 신청하기</button>
					<button
						class="sizefullbbbbb con-tc con-rad2 hov1 s-text1 trans-0-4" onclick="location.href='/tesa/consert'">
						공연 스케줄 확인하기</button>
							<button
...
function r_reserve(){
	...
	window.open("/tesa/c_re_detail/${cdelist.C_CODE}","좌석 예약","width=745,height=600, left="+ popupX + ", top="+ popupY + ", screenX="+ popupX + ", screenY= "+ popupY)
}
</script>