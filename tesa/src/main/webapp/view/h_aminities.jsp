					...
					<div class="row">
						<div class="col-xs-10 text-right menu-1 margin-auto">
							<ul>
								...
								<li><a href="h_aminities.jsp"><b>Aminities</b></a></li>
			...
			<div class="container">
				<div class="row">
					<div class="amenities-flex">
						<div class="amenities-img animate-box" style="background-image: url(../images/hotel/amenities-1.jpg);"></div>
						...
						<div class="amenities-img animate-box" style="background-image: url(../images/hotel/room-5.jpg);"></div>
						<div class="amenities-img animate-box" style="background-image: url(../images/hotel/amenities-2.jpg);"></div>
						<div class="desc animate-box">
						...
						<div class="amenities-img animate-box" style="background-image: url(../images/hotel/amenities-3.jpg);"></div>
					</div>
				</div>
			</div>
		</div>
