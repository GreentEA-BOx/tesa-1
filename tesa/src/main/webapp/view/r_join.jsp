...
<link rel="stylesheet" type="text/css" href="../css/r_style.css">
	...
	<!-- Slide -->
	<section class="bg-title-page p-t-100 p-b-40 flex-col-c-m">
	...
	<section class="bg-title-page p-b-140 flex-col-c-m">
		...
		<div class="applyDiv">
				...
				<ul>
					...
					<li class="joinli">
						...
						<div class="right inputArea">
							<input type="tel" placeholder="01012345678" maxlength="13" />
						</div>
					</li>
					<hr>
					<li class="joinli">
						...
						<div class="right inputArea">
							...
							--><select  id="rqstEmailTail" class="reser_select22" title="이메일" >
					...
					<li class="joinli">
						...
						<div class="right inputArea">
							<select name="prcpnDt_y" id="year" class="reser_select2" title="참여일(년도)">
								<option value="">년도 선택</option>
								<option value="2018">2018년</option>
								</select><!--
							--><select name="prcpnDt_m" id="month" class="reser_select2" title="참여일(월)">
								<option value="">월 선택</option>
								<option value="201810">201810월</option>
								</select><!--
							--><select name="prcpnDt" id="day" class="reser_select2" title="참여일(일)">
			...
			<!-- tq -->
			<p class="tit">손님참여 프로그램 신청 아동보호자<br /> (법정대리인) 동의서</p><!-- 2018-05-03 수정 -->
			...
			<div class="writeType1">
				<ul>
					<li class="tableNo">
						...
						<div class="right inputArea">
							<select name="rqstRelNm" class="reser_select2">
			...
			<div class="writeType1">
				<ul>
					...
					<li  class="joinli">
						...
						<div class="right inputArea">
							<select name="prcpnTitlVal" class="reser_select2"  title="옷사이즈">
					...
					<li  class="joinli">
						...
						<div class="right inputArea">
							<select name="prcpnTitlVal" class="reser_select2"  title="옵션">
								<option value="">선택</option>
					...
					<li  class="joinli">
						...
						<div class="right inputArea">
							<select name="prcpnTitlVal" class="reser_select2"  title="참여자 나이">
								<option value="">선택</option>
			...
			<p class="tit tit">참여 정보</p>
			<p class="cPurple">※ 공연은 단일 또는 다중으로 참여가 가능합니다.</p>				
			<p style="color:red; font-weight:bold; margin-top:20px;">※ 원하시는 공연만 선택바랍니다.</p>			
			<hr class="hrtitle">
			<div class="writeType1">
				<ul>
					<li  class="joinli">
					...
					<li  class="joinli">
						...
						<div class="right inputArea">
							<p class="txt">
								<select name="prfmTimeList1033" class="reser_select2" title="공연시간" data-seq="1033">
					...
					<li  class="joinli">												
						...
						<div class="right inputArea">
							<select name="prfmPrcpnTitlVal1033" class="reser_select2" title="희망 배역" data-prfm-clas-seq="182">
				...
				<ul><hr class="hrtitle">
					...
					<li  class="joinli">
						...
						<div class="right inputArea">
							<p class="txt">
								<select name="prfmTimeList1033" class="prfmTime notRequired" title="공연시간" data-seq="1033">
									<option value="">공연시간</option>
								</select>
							</p>
						</div>
...
※ 귀하는 개인정보 수집, 이용에 대한 동의를 거부하실 권리가 있으며, 동의를 거부하실 경우 서비스 이용이 제한됩니다.</textarea>
		...
		<div class="btnArea">
			<a href="javascript:" class="purpleBtn submit">신청</a>
			<a href="./view.do?detailsKey=30&pageIndex=" class="bPurpleBtn cancel">취소</a>
		</div>
		</form>
	</div>
</section>
