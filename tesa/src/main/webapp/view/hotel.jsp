	...
	<div id="page">
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="index.jsp">Luxehotel</a></div>
						</div>
						<div class="col-xs-10 text-right menu-1">
							<ul>
								<li class="active"><a href="index.jsp">Home</a></li>
								<li class="has-dropdown">
									<a href="rooms-suites.jsp">Rooms</a>
									<ul class="dropdown">
								...
								<li><a href="dining-bar.jsp">Dining &amp; Bar</a></li>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(../images/hotel/img_bg_5.jpg);">
			   	...
			   	<li style="background-image: url(../images/hotel/img_bg_1.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
			   	...
			   	<li style="background-image: url(../images/hotel/img_bg_3.jpg);">
			   		<div class="overlay"></div>
			   	...
			   	<li style="background-image: url(../images/hotel/img_bg_4.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
					...
					<div class="col-md-12 search-wrap">
		                ...
		                <div class="col-md-3">
		                  <div class="form-group">
		                    ...
		                    <div class="wrap-inputdate my-calendar-calc pos-relative txt10 size11 bo16 text-white bo-rad-10 m-l-2 m-t-3 m-b-23">
									<input class="my-calendar text-white op-0-7 bo-rad-10 sizefull txt10 p-l-15" type="text" name="date">
		                ...
		                <div class="col-md-3">
		                  <div class="form-group">
		                    ...
		                    <div class="wrap-inputdate my-calendar-calc pos-relative txt10 size11 bo16 text-white bo-rad-10 m-l-2 m-t-3 m-b-23">
								<input class="my-calendar bo-rad-10 text-white op-0-7 sizefull txt10 p-l-15" type="text" name="date">
								<i class="btn-calendar fa fa-calendar ab-r-m hov-pointer m-r-18" aria-hidden="true"></i>
							</div>
		                  </div>
		                </div>
				...
				<div class="row">
					<div class="col-md-12 animate-box">
						<div class="owl-carousel owl-carousel2">
							<div class="item">
								<a href="../images/hotel/room-1.jpg" class="room image-popup-link" style="background-image: url(../images/hotel/room-1.jpg);"></a>
								<div class="desc text-center">
									...
									<h3><a href="rooms-suites.jsp">Suite</a></h3>
									<p class="price">
							...
							<div class="item">
								<a href="../images/hotel/room-2.jpg" class="room image-popup-link" style="background-image: url(../images/hotel/room-2.jpg);"></a>
								<div class="desc text-center">
									...
									<h3><a href="rooms-suites.jsp">Double Room</a></h3>
									<p class="price">
										<span class="currency">$</span>
							...
							<div class="item">
								<a href="../images/hotel/room-3.jpg" class="room image-popup-link" style="background-image: url(../images/hotel/room-3.jpg);"></a>
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.jsp">Family Room</a></h3>
									<p class="price">
										<span class="currency">$</span>
							...
							<div class="item">
								<a href="../images/hotel/room-4.jpg" class="room image-popup-link" style="background-image: url(../images/hotel/room-4.jpg);"></a>
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.jsp">Classic Double Room</a></h3>
									<p class="price">
										<span class="currency">$</span>
							...
							<div class="item">
								<a href="../images/hotel/room-5.jpg" class="room image-popup-link" style="background-image: url(../images/hotel/room-5.jpg);"></a>
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.jsp">Superior Double Room</a></h3>
									<p class="price">
										<span class="currency">$</span>
							...
							<div class="item">
								<a href="../images/hotel/room-6.jpg" class="room image-popup-link" style="background-image: url(../images/hotel/room-6.jpg);"></a>
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.jsp">Superior Family Room</a></h3>
									<p class="price">
			...
			<div class="container">
				...
				<div class="row">
					<div class="diningbar-flex">
								...
								<div role="tabpanel" class="tab-pane active" id="mains">
									<div class="row">
										<div class="col-md-12">
											<ul class="menu-dish">
							              <li>
							                <figure class="image"><img src="../images/hotel/menu-1.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							              ...
							              <li>
							                <figure class="image"><img src="../images/hotel/menu-2.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							              ...
							              <li>
							                <figure class="image"><img src="../images/hotel/menu-3.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							              ...
							              <li>
							                <figure class="image"><img src="../images/hotel/menu-4.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
								...
								<div role="tabpanel" class="tab-pane" id="drinks">
									<div class="row">
										<div class="col-md-12">
											<ul class="menu-dish">
							              <li>
							                <figure class="image"><img src="../images/hotel/menu-8.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							              ...
							              <li>
							                <figure class="image"><img src="../images/hotel/menu-9.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							                  <span class="price">$20.50</span>
							                  <h3>Tuna Roast Source</h3>
							                  <p class="cat">Tuna / Potatoes / Rice</p>
			         ...
			         <div class="half diningbar-img" style="background-image: url(../images/hotel/cover_img_1.jpg);"></div><!-- end half -->
			      </div>
			   </div>
	      </div>
		</div>
		...
		<div id="colorlib-blog">
			<div class="container">
				...
				<div class="blog-flex">
					<div class="video colorlib-video" style="background-image: url(../images/hotel/blog-3.jpg);">
					...
					<div class="blog-entry">
						<div class="row">
							<div class="col-md-12 animate-box">
								<a href="blog.jsp" class="blog-post">
									<span class="img" style="background-image: url(../images/hotel/blog-1.jpg);"></span>
									<div class="desc">
							...
							<div class="col-md-12 animate-box">
								<a href="blog.jsp" class="blog-post">
									<span class="img" style="background-image: url(../images/hotel/blog-2.jpg);"></span>
									<div class="desc">
										<span class="date">January 14, 2018</span>
							...
							<div class="col-md-12 animate-box">
								<a href="blog.jsp" class="blog-post">
									<span class="img" style="background-image: url(../images/hotel/blog-3.jpg);"></span>
									<div class="desc">
										<span class="date">January 14, 2018</span>
			...
			<div class="container">
				...
				<div class="col-md-4 animate-box">
					<div class="testimony text-center">
						<span class="img-user" style="background-image: url(../images/hotel/person2.jpg);"></span>
				...
				<div class="col-md-4 animate-box">
					<div class="testimony text-center">
						<span class="img-user" style="background-image: url(../images/hotel/person1.jpg);"></span>
				...
				<div class="col-md-4 animate-box">
					<div class="testimony text-center">
						<span class="img-user" style="background-image: url(../images/hotel/person3.jpg);"></span>
		...
		<div id="colorlib-subscribe" style="background-image: url(../images/hotel/img_bg_2.jpg);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading animate-box">
