		...
		<div class="container-menu-header">
			...
			<div class="wrap_header">
				...
				<a href="index.jsp" class="logo">
					<img src="images/tesa.png" alt="IMG-LOGO">
				</a>
					...
					<nav class="menu">
						<ul class="main_menu">
							<li>
								...
								<ul class="sub_menu">
									<li><a href="attrection.jsp">Attraction</a>
										<ul class="sub_menu">
							...
							<li>
								<a href="${pageContext.request.contextPath}/view/hotel.jsp">Hotel</a>
							</li>

							<li>
								<a href="${pageContext.request.contextPath}/view/dining.jsp">Dining</a>
							</li>

							<li>
								<a href="${pageContext.request.contextPath}/view/bus.jsp">Bus</a>
							</li>

							<li>
								<a href="${pageContext.request.contextPath}/view/dh_support.jsp">Support</a>
							</li>
						</ul>
					</nav>
				</div>
